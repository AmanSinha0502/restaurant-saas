  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[hsl(var(--background))] text-[hsl(var(--foreground))]">
      ...
      >
        ...
        <h1 className="text-2xl font-bold mb-2 text-center">Owner / Staff Login</h1>
        <p className="tiny muted mb-6 text-center">Access Restaurant Management Dashboard</p>
